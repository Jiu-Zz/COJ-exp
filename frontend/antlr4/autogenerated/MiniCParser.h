...
public:
  ...
  enum {
    RuleCompileUnit = 0, RuleFuncDef = 1, RuleFuncType = 2, RuleBlock = 3, 
    RuleBlockItemList = 4, RuleBlockItem = 5, RuleVarDecl = 6, RuleBasicType = 7, 
    RuleFuncFParams = 8, RuleFuncFParam = 9, RuleVarDef = 10, RuleStatement = 11, 
    RuleExpr = 12, RuleLOrExp = 13, RuleLAndExp = 14, RuleEqExp = 15, RuleRelExp = 16, 
    RuleAddExp = 17, RuleAddOp = 18, RuleMulExp = 19, RuleMulOp = 20, RuleUnaryExp = 21, 
  ...
  public:
    ...
    std::vector<antlr4::tree::TerminalNode *> T_CONST();
    antlr4::tree::TerminalNode* T_CONST(size_t i);
